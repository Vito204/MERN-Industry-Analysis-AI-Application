...
const IndustryAnalysisAIAssistant = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      mutation.mutate(
        `Generate an industry analysis based ${values.prompt}, ${values.tone}`
      );
      ...
      <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-2xl w-full p-6">
        ...
        <div className="flex mt-3">
          <div className="mr-2 mb-4">
            <span className="text-sm font-semibold bg-green-300 px-4 py-2 rounded-full">
...
export default IndustryAnalysisAIAssistant;
